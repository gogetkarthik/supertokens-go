...
type DeleteSessionParams struct {
	...
	/*SessionDeleteInput*/
	SessionDeleteInput *models.SessionDeleteInput
...
// WithSessionDeleteInput adds the sessionDeleteInput to the delete session params
func (o *DeleteSessionParams) WithSessionDeleteInput(sessionDeleteInput *models.SessionDeleteInput) *DeleteSessionParams {
	o.SetSessionDeleteInput(sessionDeleteInput)
	return o
}

// SetSessionDeleteInput adds the sessionDeleteInput to the delete session params
func (o *DeleteSessionParams) SetSessionDeleteInput(sessionDeleteInput *models.SessionDeleteInput) {
	o.SessionDeleteInput = sessionDeleteInput
}
...
func (o *DeleteSessionParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.SessionDeleteInput != nil {
		if err := r.SetBodyParam(o.SessionDeleteInput); err != nil {
			return err
		}
	}
