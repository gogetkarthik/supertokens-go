...
// WithSessionInput adds the sessionInput to the create session params
func (o *CreateSessionParams) WithSessionInput(sessionInput *models.SessionInput) *CreateSessionParams {
	o.SetSessionInput(sessionInput)
	return o
}

// SetSessionInput adds the sessionInput to the create session params
func (o *CreateSessionParams) SetSessionInput(sessionInput *models.SessionInput) {
	o.SessionInput = sessionInput
}
...
func (o *CreateSessionParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.SessionInput != nil {
		if err := r.SetBodyParam(o.SessionInput); err != nil {
			return err
		}
	}
